...
// Funcion de carga de texturas e inicializacion
{
	...
	FREE_IMAGE_FORMAT formato = FreeImage_GetFileType("gato.jpg", 0);
	// Automatically detects the format
	FIBITMAP* imagen = FreeImage_Load(formato, "gato.jpg");
...
// x,y: coordenadas del cursor referidas al pixel superior izquierdo(0,0)
{
	...
	case GIRO: // La acumulación del giro se produce aqui
